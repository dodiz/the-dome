						...
						<FrameBox palette="secondary">
							<div className="arwes__box">
								...
								<Text as="p">
									...
									unde fugiat facilis nisi vitae quas laboriosam culpa quasi
									enim officiis pariatur possimus deserunt, numquam repellendus
									nulla rem laborum quidem veniam reiciendis temporibus.
									Praesentium repellat fugiat saepe facere asperiores natus
									laborum repudiandae dolor dolorem dolorum, quam sit tempora
									minus laudantium obcaecati, commodi ab voluptates aliquam
									quasi est aut? Similique consequuntur sed ea odio eius tempore
									error neque quisquam, recusandae fugit!
								</Text>
							</div>
						</FrameBox>
					</div>
